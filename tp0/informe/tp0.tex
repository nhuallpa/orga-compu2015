...
\author{	Martinez Ariel, \textit{Padrón Nro. 88573}\\
			...
			Facundo Caldora, \textit{Padrón Nro. 93194] }\\
            \texttt{ facundo.caldora@gmail.com }\\\\               
            \texttt{\footnotesize 1º Entrega: 22/09/2015}\\
            \\\\\\\\\\\\\\\\\\
...
El objetivo del presente trabajo práctico es familiarizarse con el emulador gxemul mediante la implementacion de un programa simple de multiplicación de matrices.
...
de la multiplicacion se lo imprime por salida estándar (stdout). La función \texttt{main} se encuentra en \texttt{tp0.c} 
...
\begin{enumerate}
	...
	\item 	Prueba 2
		...
		\begin{center}
			...
			que genera un archivo de entrada con dos matrices muy grandes. Adicionalmente este script corre el programa tp0 con valgrind.
			\begin{tabbing}
			------- \= ----- \= \kill
...
\section{{\normalsize El código fuente, en lenguaje C}}
	...
	\lstinputlisting[language=C, basicstyle=\tiny]{tp0.c}	

\newpage
\section{{\normalsize El código MIPS32 generado por el compilado}}

	\lstinputlisting[language={[x86masm]Assembler}, firstline=1, lastline=45, basicstyle=\small]{tp0.s}
