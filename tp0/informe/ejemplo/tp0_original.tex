...
\author{	Martinez Ariel, \textit{Padrón Nro. 88573}\\
			...
			Dworjanyn Enrique, \textit{Padrón Nro.84253 }\\
            \texttt{ dworja@hotmail.com }\\\\               
            \texttt{\footnotesize 1º Entrega: 13/09/2011}\\
	    \texttt{\footnotesize 2º Entrega: 27/09/2011}\\
	    \texttt{\footnotesize 3º Entrega: 25/10/2011}\\\\ \\\\\\\\\\\\\\
            \\\\\\\\\\\\\\\\\\
...
conclusiones relacionadas al desarrollo e implementación de algunas 
funcionalidades del comando Tac de Unix.
\end{abstract}
\newpage{}
\tableofcontents
\newpage{}
